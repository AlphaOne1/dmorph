...
[a feature request](https://github.com/AlphaOne1/dmorph/discussions/new?category=ideas)
...
you're adding new features or bugfixes to *DMorph*, please include tests.
...
[please create a GitHub discussion](https://github.com/AlphaOne1/dmorph/discussions/new).
If you've noticed a bug, [please submit an issue][new issue].


### Fork and create a branch

If this is something you think you can fix, then [fork dmorph] and create a
